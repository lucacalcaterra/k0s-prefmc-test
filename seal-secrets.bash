...
kubeseal --format=yaml < ../ArgoCD-Secrets/traefik-sso-secrets.yaml  > manifests/traefik-forward-auth/traefik-sso-secrets-sealed.yaml
...
kubeseal --format=yaml < ../ArgoCD-Secrets/qbittorrent-vpn-auth-secrets.yaml  > manifests/qbittorrent/templates/qbittorrent-vpn-auth-secrets.yaml
